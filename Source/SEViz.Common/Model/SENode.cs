...
namespace SEViz.Common.Model
{
    public class SENode
    {
        ...
        public int sColor
        {
            ...
            set
            {
                Color = (NodeColor)Enum.ToObject(typeof(NodeColor), value);
        ...
        public int sBorder
        {
            ...
            set
            {
                Border = (NodeBorder)Enum.ToObject(typeof(NodeBorder), value);
            }
        }
        ...
        public int sShape
        {
            ...
            set
            {
                Shape = (NodeShape)Enum.ToObject(typeof(NodeBorder), value);
            }
        }
        ...
        internal HashSet<SENode> CollapsedSubtreeNodes
        {
            get; private set;
        }

        internal HashSet<SEEdge> CollapsedSubtreeEdges
        {
            get; private set;
        }
